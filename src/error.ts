...
export const createRateLimitError = (
	...
	createVerbError(message, 429, "RATE_LIMIT_EXCEEDED", details);
 ...
 */
export const defaultErrorHandler = (error: Error, req: Request): Response => {
...
export const handleError = async (
	...
	const handler =
		boundary.handlers.get(error.constructor.name) || boundary.fallbackHandler;
